...
import 'package:daily_design_to_code/presentation/product_detail/widget/facilities_card.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class LocationDetailView extends StatelessWidget {
  final ListPopular popularItem;
  const LocationDetailView({super.key, required this.popularItem});
