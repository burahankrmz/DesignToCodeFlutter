...
class TravelAppHomePopularWidget extends StatelessWidget {
  const TravelAppHomePopularWidget({super.key});
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemCount: TravelAppListPopular.items.length,
            itemBuilder: (context, index) {
              return _PopularItem(popularItem: TravelAppListPopular.items[index], onTap: (){Navigator.pushNamed(context, TravelAppRouteConstants.locationDetailRoute, arguments: TravelAppListPopular.items[index]);});
            },
          ),
        )
      ],
